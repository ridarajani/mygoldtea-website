...
export default function Footer() {
  return (
    <footer id="footer" className="bg-green-dark text-white">
          ...
          <div>
            ...
            <div className="mt-6 flex gap-4">
              <a
                ...
                aria-label="Facebook"
                className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-gold hover:border-gold transition-colors"
              >
          ...
          <div>
            ...
            <div className="mt-4 space-y-4">
              <div className="flex gap-3">
                <svg
                  className="w-5 h-5 text-gold-light flex-shrink-0 mt-0.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
