        ...
        <ScrollReveal>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-4 text-lg text-brown">
              Explore our range of premium cookies, fine tea, quality margarine,
              wholesome rice, and delicious snacks crafted for every taste.
            </p>
          </div>
        </ScrollReveal>
        ...
        <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {featuredProducts.map((product, i) => (
            <ScrollReveal key={product.name} delay={i * 100}>
              <div className="group rounded-3xl bg-cream overflow-hidden border border-cream-dark hover:border-gold/30 hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
                {/* Product Image */}
